...
export var car1=[
    {id:1, title: "Audi A3", Price: 39000, Comapany:'Audi', img: "https://hips.hearstapps.com/hmg-prod/images/2025-audi-a3-sedan-front-in-motion-65ef2c4d03100.jpg?crop=0.454xw:0.328xh;0.401xw,0.375xh&resize=700:*", Category: "Luxury Car", des:"The 2025 A3 sedan is the smallest car Audi sells in North America but despite its diminutive size this compact four-door delivers a lively driving experience, one that's reminiscent of what you'll find in the brand's larger sports sedans. A 201-hp turbocharged 2.0-liter four-cylinder delivers modest pep, but runs smoothly and is eager to rev."} ,
    {id:2, title: "Mercedes-Benz CLA-Class", Price: 45000, Comapany:'Mercedes-Benz', img: "https://hips.hearstapps.com/hmg-prod/images/2025-mercedes-cla-class-1-jpg-6725375016416.jpg?crop=0.639xw:0.543xh;0.280xw,0.411xh&resize=1200:*", Category: "Luxury Car", des:"The least expensive model in the Mercedes Benz’s stateside lineup, the compact CLA-class four-door sedan does an admirable job of bringing together the brand’s familial styling elements and upscale appointments. While it lacks many of the over-the-top features of the maker’s most premium sedans, it offers modest amounts of luxury with features that include a standard sunroof, a 10.3-inch infotainment screen, an attractively sculpted dashboard and door panels, and a dramatic coupe-like profile."} ,
    {id:3, title: "Lamborghini Huracán", Price: 45000, Comapany:'Lamborghini', img: "https://manofmany.com/wp-content/uploads/2021/04/Top-15-Best-Sports-Cars-Power-Luxury-and-Design-Lamborghini-Huracan-768x576.jpeg",Category: "Sports Car", des:"The least expensive model in the Lamborghini stateside lineup, the compact CLA-class four-door sedan does an admirable job of bringing together the brand’s familial styling elements and upscale appointments. While it lacks many of the over-the-top features of the maker’s most premium sedans, it offers modest amounts of luxury with features that include a standard sunroof, a 10.3-inch infotainment screen, an attractively sculpted dashboard and door panels, and a dramatic coupe-like profile."} ,
    {id:4, title: "Audi R8", Price: 43000, Comapany:'Audi', img: "https://manofmany.com/wp-content/uploads/2021/04/Top-15-Best-Sports-Cars-Power-Luxury-and-Design-Audi-R8-768x576.jpeg",Category: "Sports Car", des:"Track-tested and road-approved, the Audi R8 Coupe delivers top shelf performance and jaw-dropping style in equal measure. Featuring about half the same specs as the brand’s R8 LMS GT3 race car, this is accordingly one powerful, lightweight ride. The R8’s naturally aspirated 5.2 V10 engine generates up to 610 hp and 413 ft-lbs of torque, getting the car from 0-62 mph in 3.2 seconds flat. Also featured on the standard model is seven-speed automatic transmission, all-wheel drive and a downright gorgeous interior awash with comfort and technology."} ,

    //discover
    {id:5, title: "Acura TLX", Price: 25000, Comapany:'Acura', img: "https://metropolitanhost.com/themes/themeforest/angular/rims/assets/images/showcar7.jpg",Category: "Economy Car", des:"A masterful combination of style, power, sporty handling and comfort."} ,
    {id:6, title: "BMW 4 Series", Price: 20000, Comapany:'BMW', img: "https://metropolitanhost.com/themes/themeforest/angular/rims/assets/images/showcar8.jpg",Category: "Economy Car", des:"A masterful combination of style, power, sporty handling and comfort."} ,
    {id:7, title: "BMW 4 Series", Price: 30000, Comapany:'BMW', img: "https://metropolitanhost.com/themes/themeforest/angular/rims/assets/images/showcar9.jpg",Category: "Economy Car", des:"A masterful combination of style, power, sporty handling and comfort."} ,

    // featured
    {id:8, title: "Ghibli", Price: 25000, Comapany:'Acura', img: "https://metropolitanhost.com/themes/themeforest/angular/rims/assets/images/showcar7.jpg",Category: "Economy Car", des:"A masterful combination of style, power, sporty handling and comfort.", Engine_Layout:"V6", Displacement:"2979 cc", Acc:'5.5sec', M_Power:"350HP"} ,
    {id:9, title: "Ghibli S", Price: 20000, Comapany:'BMW', img: "https://metropolitanhost.com/themes/themeforest/angular/rims/assets/images/showcar8.jpg",Category: "Economy Car", des:"A masterful combination of style, power, sporty handling and comfort.",Engine_Layout:"V6", Displacement:"5979 cc", Acc:'4.5sec', M_Power:"550HP"} ,
    {id:10, title: "Ghibli S Q4", Price: 30000, Comapany:'BMW', img: "https://metropolitanhost.com/themes/themeforest/angular/rims/assets/images/showcar9.jpg",Category: "Economy Car", des:"A masterful combination of style, power, sporty handling and comfort.", Engine_Layout:"V8", Displacement:"2639 cc", Acc:'6.5sec', M_Power:"450HP"} ,

    //banner
    {id:11, title: "Ghibli", Price: 25000, Comapany:'Acura', img: "https://metropolitanhost.com/themes/themeforest/angular/rims/assets/images/banner/bannerh4.jpg",Category: "Economy Car", des:"A masterful combination of style, power, sporty handling and comfort.", Engine_Layout:"V6", Displacement:"2979 cc", Acc:'5.5sec', M_Power:"350HP"} ,
    {id:12, title: "Ghibli S", Price: 20000, Comapany:'BMW', img: "https://metropolitanhost.com/themes/themeforest/angular/rims/assets/images/banner/bannerh4a.jpg",Category: "Economy Car", des:"A masterful combination of style, power, sporty handling and comfort.",Engine_Layout:"V6", Displacement:"5979 cc", Acc:'4.5sec', M_Power:"550HP"} ,
    {id:13, title: "Audi R8 Marine", Price: 30000, Comapany:'Audi', img: "https://metropolitanhost.com/themes/themeforest/angular/rims/assets/images/banner/bannerh12.jpg",Category: "Economy Car", des:"A masterful combination of style, power, sporty handling and comfort.", Engine_Layout:"V8", Displacement:"2639 cc", Acc:'6.5sec', M_Power:"450HP"} ,
...
export var Company=[
    ...
    {id:1, catname:"Audi", img:"https://metropolitanhost.com/themes/themeforest/angular/rims/assets/images/logos/80x55/category-3.png"},
    {id:2, catname:"Mercedes-Benz", img:"https://metropolitanhost.com/themes/themeforest/angular/rims/assets/images/logos/80x55/category-5.png"},
    {id:3, catname:"Lamborghini", img:"https://metropolitanhost.com/themes/themeforest/angular/rims/assets/images/logos/80x55/category-7.png"},
    {id:4, catname:"Acura", img:"https://metropolitanhost.com/themes/themeforest/angular/rims/assets/images/logos/80x55/category-2.png"},
    {id:5, catname:"BMW", img:"https://metropolitanhost.com/themes/themeforest/angular/rims/assets/images/logos/80x55/category-4.png"}
